...
struct Attributes // Vertex Stage Input
{
    ...
    float2 uv0 :TEXCOORD0; // coordinates for texture
    float2 uv1 :TEXCOORD1; // for lightmaps
    float2 uv2 :TEXCOORD2; // for lightmaps
...
struct Varyings // Vertex Output - Fragment Input
{
    ...
    float2 uv :TEXCOORD0; // coordinates for texture
